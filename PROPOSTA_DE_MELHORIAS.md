...
- **Próximo bloco recomendado:** validar o fallback real de T06 e os cenários residuais de B13/B14 no Android. O app lock opcional de T07 ainda exige decisão de escopo; primeira abertura do calendário em release, datasets grandes no aparelho, iOS e o pipeline externo de B17 continuam pendentes.
...
12. **T06 — Error Boundary implementado:** fallback bilíngue, retry com remontagem completa e métricas sem mensagem/stack; validação visual do fallback real ainda pendente.
...
- B13 e B14 receberam validação parcial no Android conectado. Primeira abertura fria do calendário, responsividade, iOS e cenários extremos de imagem ainda precisam de confirmação.
