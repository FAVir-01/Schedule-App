...
- **16 de julho de 2026 — GIF animado de B14 validado em Android:** um GIF real de 385 quadros e 516.586 bytes foi selecionado pelo Photo Picker, copiado para o sandbox mantendo tamanho e extensão `.gif`, exibido no calendário e não gerou erro ou troca de PID. O fundo e os arquivos de teste foram removidos depois; arquivos acima do limite, falha física de cópia e iOS continuam pendentes.
- **Próximo bloco recomendado:** tratar a montagem fria de B13 com profiling de renderização/decodificação no build release e validar arquivos acima do limite de B14. O app lock opcional de T07 ainda exige decisão de escopo; datasets grandes no aparelho, iOS e o pipeline externo de B17 continuam pendentes.
...
7. **B14 — implementado e validado parcialmente em Android:** persistência segura aplicada aos quatro usos de imagem, com feedback e limites; PNG e GIF animado passaram, enquanto iOS, arquivo acima do limite e falha física continuam pendentes.
